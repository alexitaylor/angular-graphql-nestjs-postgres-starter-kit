...
@NgModule({
  ...
  declarations: [LoaderComponent, ControlMessagesComponent, ReversePipe, FormatDatePipe, HasAnyAuthorityDirective],
  providers: [ValidationService],
  exports: [LoaderComponent, ControlMessagesComponent, ReversePipe, FormatDatePipe, HasAnyAuthorityDirective]
})
